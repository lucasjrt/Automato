...
int main() {
    ...
    while(repete=='s'){
        ...
        reconheceu = reconhece(a,cadeia,a->estado_inicial);
...
/*
    ...
    a->funcoes[10].estado1[0] = '3'; a->funcoes[10].estado1[1] = '\0'; a->funcoes[10].transicao = 'c'; a->funcoes[10].estado2[0] = '5'; a->funcoes[10].estado2[1] = '\0';
    a->funcoes[11].estado1[0] = '4'; a->funcoes[11].estado1[1] = '\0'; a->funcoes[11].transicao = 'd'; a->funcoes[11].estado2[0] = '5'; a->funcoes[11].estado2[1] = '\0';
    a->funcoes[12].estado1[0] = '4'; a->funcoes[12].estado1[1] = '\0'; a->funcoes[12].transicao = '&'; a->funcoes[12].estado2[0] = '3'; a->funcoes[12].estado2[1] = '\0';
    a->num_funcoes = 13;
    a->estado_inicial[0] = '1'; a->estado_inicial[1] = '\0';
